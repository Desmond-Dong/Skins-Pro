...
| **AEON_glass** | Dark frosted glass<br>暗色毛玻璃 | AEON aesthetic with enhanced glass blur effect<br>AEON 风格，增强毛玻璃模糊效果 |
...
| modern | AEON | AEON_glass | visionOS | minecraft |
|---|---|---|---|---|
| ![modern](screenshots/modern.png) | ![AEON](screenshots/AEON.png) | ![AEON_glass](screenshots/AEON_glass.png) | ![visionOS](screenshots/visionOS.png) | ![minecraft](screenshots/minecraft.png) |
